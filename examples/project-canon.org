...
that an LLM can reference during code review when used with Polymuse.

This particular example documents the Polymuse project itself, showing how
you might use Canon to maintain architecture and coding standards documentation
for an Emacs package.
